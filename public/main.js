...
module.exports = "<body class=\"vsc-initialized\">\n  <ht-nav-bar></ht-nav-bar>\n  <div class=\"container\">\n    <flash-messages></flash-messages>\n    <router-outlet></router-outlet>\n  </div>\n</body>\n"
...
var AppComponent = /** @class */ (function () {
    ...
    function AppComponent(authService) {
        ...
        this.authService.apiUrl = _environments_environment__WEBPACK_IMPORTED_MODULE_2__["environment"].apiUrl;
    }
...
/* harmony import */ var _shared_components_nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./shared/components/nav-bar/nav-bar.component */ "./src/app/shared/components/nav-bar/nav-bar.component.ts");
...
/* harmony import */ var _shared_routes_app_routing__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./shared/routes/app.routing */ "./src/app/shared/routes/app.routing.ts");
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["NgModule"])({
            declarations: [
                ...
                _shared_components_nav_bar_nav_bar_component__WEBPACK_IMPORTED_MODULE_9__["NavBarComponent"],
            ...
            imports: [
                ...
                _shared_routes_app_routing__WEBPACK_IMPORTED_MODULE_16__["routing"],
            ...
            providers: [_shared_routes_app_routing__WEBPACK_IMPORTED_MODULE_16__["appRoutingProviders"], _services_validate_service__WEBPACK_IMPORTED_MODULE_15__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], _shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_0__["AuthGuard"]],
...
module.exports = "<div class=\"bs-component\">\n  <div class=\"row\">\n    <div class=\"col-lg-12\">\n      <h2 id=\"type-blockquotes\">Specs</h2>\n    </div>\n  </div>\n  <div class=\"row\">\n    <div class=\"col-lg-4\">\n      <div class=\"bs-component\">\n        <blockquote class=\"blockquote\">\n          <p class=\"mb-0\">Express Backend</p>\n          <footer class=\"blockquote-footer\">Express.js, or simply Express, is a web application framework for Node.js,\n            released\n            as free and open-source software under the MIT License. It is designed for building web applications and\n            APIs</footer>\n        </blockquote>\n\n      </div>\n    </div>\n    <div class=\"col-lg-4\">\n      <div class=\"bs-component\">\n        <blockquote class=\"blockquote text-center\">\n          <p class=\"mb-0\">Angular CLI</p>\n          <footer class=\"blockquote-footer\">The Angular CLI makes it easy to create an application that already works,\n            right out\n            of the box. It already follows our best practices!</footer>\n        </blockquote>\n      </div>\n    </div>\n    <div class=\"col-lg-4\">\n      <div class=\"bs-component\">\n        <blockquote class=\"blockquote text-right\">\n          <p class=\"mb-0\">JWT Token</p>\n          <footer class=\"blockquote-footer\">JSON Web Token is a JSON-based open standard for creating access tokens\n            that\n            assert\n            some number of claims. For example, a server could generate a token that has the claim \"logged in as admin\"\n            and\n            provide that to a client.</footer>\n        </blockquote>\n      </div>\n    </div>\n  </div>\n</div>\n"
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(validateService, authService, flashMessagesService, router) {
        ...
        if (!this.validateService.validateLogin(user)) {
            ...
            this.authService.loginUser(user).subscribe(function (data) {
                if (data['success'] === true) {
                    _this.authService.storeTokenData(data['token'], data['user']);
    ...
    LoginComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_validate_service__WEBPACK_IMPORTED_MODULE_4__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_3__["AuthService"],
            angular2_flash_messages__WEBPACK_IMPORTED_MODULE_1__["FlashMessagesService"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], LoginComponent);
...
var RegisterComponent = /** @class */ (function () {
    ...
    RegisterComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_services_validate_service__WEBPACK_IMPORTED_MODULE_1__["ValidateService"], _services_auth_service__WEBPACK_IMPORTED_MODULE_0__["AuthService"],
            angular2_flash_messages__WEBPACK_IMPORTED_MODULE_3__["FlashMessagesService"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["Router"]])
    ], RegisterComponent);
...
var AuthService = /** @class */ (function () {
    function AuthService(http, jwtHelperService) {
        ...
        this.apiUrl = ""; // For Developement
    }
    AuthService.prototype.addUser = function (user) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json; charset=utf-8');
        return this.http.post(this.apiUrl + "users/register", user, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            return data;
        }));
    };
    AuthService.prototype.loginUser = function (user) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json; charset=utf-8');
        return this.http.post(this.apiUrl + "users/authenticate", user, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            return data;
        }));
    };
    AuthService.prototype.getProfile = function () {
        ...
        return this.http.get(this.apiUrl + "users/profile", { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            return data;
        }));
    };
    AuthService.prototype.storeTokenData = function (token, user) {
    ...
    AuthService = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"], _auth0_angular_jwt__WEBPACK_IMPORTED_MODULE_3__["JwtHelperService"]])
    ], AuthService);
    return AuthService;
}());
...
var NavBarComponent = /** @class */ (function () {
    ...
    NavBarComponent = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["Component"])({
            ...
            styles: [__webpack_require__(/*! ./nav-bar.component.css */ "./src/app/shared/components/nav-bar/nav-bar.component.css")]
        }),
        __metadata("design:paramtypes", [_services_auth_service__WEBPACK_IMPORTED_MODULE_1__["AuthService"], angular2_flash_messages__WEBPACK_IMPORTED_MODULE_3__["FlashMessagesService"], _angular_router__WEBPACK_IMPORTED_MODULE_0__["Router"]])
    ], NavBarComponent);
...
/* harmony import */ var _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../../components/dashboard/dashboard.component */ "./src/app/components/dashboard/dashboard.component.ts");
...
/* harmony import */ var src_app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! src/app/shared/guards/auth.guard */ "./src/app/shared/guards/auth.guard.ts");
...
var appRoutes = [
    ...
    { path: 'dashboard', component: _components_dashboard_dashboard_component__WEBPACK_IMPORTED_MODULE_0__["DashboardComponent"], canActivate: [src_app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]] },
    { path: 'profile', component: _components_profile_profile_component__WEBPACK_IMPORTED_MODULE_5__["ProfileComponent"], canActivate: [src_app_shared_guards_auth_guard__WEBPACK_IMPORTED_MODULE_6__["AuthGuard"]] }
];
var appRoutingProviders = [];
var routing = _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forRoot(appRoutes, { useHash: true });
...
module.exports = __webpack_require__(/*! /home/test/Hitesh/Tech/Node/mean-authapp/angular-src/src/main.ts */"./src/main.ts");
