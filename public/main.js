...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.addUser = function (user) {
        ...
        return this.http.post(this.url + "users/register", user, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            return data;
        }));
    };
    AuthService.prototype.loginUser = function (user) {
        var headers = new _angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpHeaders"]();
        headers.append('Content-Type', 'application/json; charset=utf-8');
        return this.http.post(this.url + "users/authenticate", user, {}).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            return data;
        }));
    };
    AuthService.prototype.getProfile = function () {
        ...
        return this.http.get(this.url + "users/profile", { headers: headers }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(function (data) {
            return data;
        }));
    };
